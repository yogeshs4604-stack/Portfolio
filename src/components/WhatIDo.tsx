        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Focus Areas</h4>
              <p>
                Crafting data-driven marketing strategies, analyzing consumer behavior, and positioning brands for maximum impact.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                <div className="what-tags">Market Research</div>
                <div className="what-tags">Strategy Development</div>
                ...
                <div className="what-tags">Strategic Thinking</div>
              </div>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Focus Areas</h4>
              <p>
                Interpreting functional data, managing business operations, and ensuring precise financial discipline.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                ...
                <div className="what-tags">Bloomberg Cert.</div>
